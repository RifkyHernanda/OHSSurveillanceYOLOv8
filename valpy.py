...
class YOLOv8:
    """YOLOv8 object detection model class forhandling inference and visualization."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="epoch50.onnx", help="Input your ONNX model.")
